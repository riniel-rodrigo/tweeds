        ...
        <div className="flex justify-center content-center items-center h-screen">
            ...
            <div className="flex flex-col justify-center content-center items-center gap-3">
                ...
                <button
                    ...
                    className="bg-indigo-400 text-white w-full rounded p-1.5 hover:bg-indigo-600 transition-all duration-[400ms]">
                    Criar nova conta
                </button>
                <div className="flex gap-2 self-center">
                    <span className="text-sm" >Já possui uma conta?</span>
                    <Link className="text-sm text-indigo-400 hover:text-indigo-800 transition-all" to="/Login">Entrar</Link>
                </div>
            </form>
        </div>
    )
